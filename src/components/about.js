...
import aboutmain from '../styles/images/about-main.jpg';
import aboutinset from '../styles/images/about-inset.jpg';
                ...
                <div className="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div className="wow fadeIn" data-wow-duration="1s" data-wow-delay="0.1s">
                        <div className="about-images">
                            <img className="about-main" src={aboutmain} alt="About Main Image" />
                            <img className="about-inset" src={aboutinset} alt="About Inset Image" />
                        </div>
                    </div>
                </div>
            </div>
